...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\elizabeth ogunmola\Desktop\Django-URLs\elizabethenv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\elizabeth ogunmola\Desktop\Django-URLs\elizabethenv\Scripts\deactivate.nu'
